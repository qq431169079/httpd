...
AP_LIBS = /home/jiangxd/src/flashapp/httpd-2.2.22/srclib/pcre/libpcre.la /home/jiangxd/src/flashapp/httpd-2.2.22/srclib/apr-util/libaprutil-1.la -lexpat /home/jiangxd/src/flashapp/httpd-2.2.22/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/jiangxd/src/flashapp/httpd-2.2.22
...
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/jiangxd/src/flashapp/httpd-2.2.22/srclib/apr/include -I/home/jiangxd/src/flashapp/httpd-2.2.22/srclib/apr-util/include -I/usr/local/include -I$(top_builddir)/server -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/jiangxd/src/flashapp/httpd-2.2.22/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
MODULE_DIRS = aaa database debug filters loggers metadata http dav/main generators dav/fs mappers
MODULE_CLEANDIRS = arch/win32 cache echo experimental ldap proxy ssl test dav/lock
PORT = 80
SSLPORT = 443
